            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  >Generando código de barras.</barcode>
                </div>
              </div>
              <div class="form-group row">
  ...
  methods: {
    ...
    validarArticulo() {
      ...
      if (!this.stock || this.stock < 0)
        this.errorMostrarMsjArticulo.push(
          "El stock del artículo debe ser un número positivo y no puede estar vacío."
        );
      if (!this.precio_venta || this.precio_venta < 0)
        this.errorMostrarMsjArticulo.push(
          "El precio de venta del artículo debe ser un número positivo y no puede estar vacío."
        );
