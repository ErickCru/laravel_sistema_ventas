                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="telefono" class="form-control" placeholder="Teléfono del proveedor">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Email</label>
                                    <div class="col-md-9">
                                        <input type="email" v-model="email" class="form-control" placeholder="Correo de la persona">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Teléfono del contacto</label>
                                    <div class="col-md-9">
...
<script>
    export default {
        ...
        methods: {
            listarPersona(page, buscar, criterio){
                ...
                .then(function (response) {
                    ...
                    if(respuesta.personas.data.length != 0){
        ...
        mounted() {
            this.listarPersona(1, this.nombre, this.criterio);
        }
    }
</script>
