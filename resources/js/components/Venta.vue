            ...
            <div class="form-group row border">
              <div class="col-md-4">
                <div class="form-grop">
                  ...
                  <div class="form-inline">
                    ...
                    >
                    <button @click="abrirModal('ingreso')" class="btn btn-primary">...</button>
              ...
              <div class="col-md-2">
                <div class="form-grou">
                  <button
                    ...
                    class="btn btn-success form-control btn-agregar"
                  >
                    <i class="icon-plus"></i>
                  </button>
                </div>
              ...
              <div class="col-md-2">
                <div class="form-grou">
                  ...
                  <input type="number" value="0" min="0" class="form-control" v-model="descuento">
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    listarVenta(page, buscar, criterio) {
      ...
      axios
        ...
        .then(function(response) {
          ...
          if (respuesta.ventas.data.length != 0 || buscar == "") {
            ...
            Swal.fire({
              type: "error",
              title: "Oops...",
              text: "No se encontró ninguna venta con ese dato",
      ...
      if (me.idarticulo == 0 || me.cantidad == 0 || me.precio == 0) {
        ...
        if (me.encuentra(me.idarticulo)) {
          Swal.fire({
            ...
            footer: "Puede modificar los valores en la tabla de abajo."
          });
        } else {
    ...
    listarArticulo(buscar, criterio) {
      let me = this;
      var url =
        "/articulo/listarArticulosVenta?buscar=" +
        buscar +
        "&criterio=" +
        criterio;
      axios
    ...
    validarVenta() {
      ...
      me.arrayDetalle.map(function(x) {
        ...
        if (x.precio * x.cantidad < x.descuento) {
          art = x.articulo + " el descuento no puede ser mayor al subtotal.";
          me.errorMostrarMsjVenta.push(art);
        }
      });
            ...
            axios
              ...
              .then(function(response) {
                ...
                swalWithBootstrapButtons.fire(
                  "¡Desactivado!",
                  "El ingreso ha sido desactivado exitosamente.",
                  "success"
                );
              })
              .catch(function(error) {
